...
class ExodusModel(object):
    ...
    def _get_element_edge_indices(self,
                                  element_type):
        """
    ...
    def _get_closest_point_distance_brute(self,
                                          points):
    ...
    def _get_closest_point_distance(self,
                                    points,
                                    sorting_coord=0,
                                    trials=0):
        """Return the distance between the two closest points."""
